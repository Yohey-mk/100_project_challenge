...
def load_ai_model():
    ...
    # loaded_columns = joblib.load('model_columns.pkl') # streamlitでDeployする際にPathの指定が←だとFile not foundになる
    loaded_columns = joblib.load('day038_scikitlearn/model_columns.pkl')
